    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-5">
        <div>
          ...
          <p className="text-teal-500 text-sm">100 dernières · filtrer ci-dessous</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-teal-100 overflow-hidden">
        {bookings.length === 0 ? (
          <div className="py-14 text-center text-teal-500/80 text-sm">
                ...
                return (
                  ...
                  >
                    <td className="py-3 px-4">
                      ...
                      <div className="md:hidden mt-1 text-teal-700 text-xs">
                    ...
                    <td className="py-3 px-4 hidden md:table-cell text-teal-700">
                      {b.room.name}
                    </td>
                    <td className="py-3 px-4 hidden sm:table-cell text-teal-600 text-xs">
